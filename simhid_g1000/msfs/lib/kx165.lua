...
module.actions = {}
module.actions[1] = {
    nav_knob_large_inc=msfs.event_sender("NAV1_RADIO_WHOLE_INC"),
    nav_knob_large_dec=msfs.event_sender("NAV1_RADIO_WHOLE_DEC"),
    nav_knob_small_inc=msfs.event_sender("NAV1_RADIO_FRACT_INC"),
    nav_knob_small_dec=msfs.event_sender("NAV1_RADIO_FRACT_DEC"),
    nav_swap=msfs.event_sender("NAV1_RADIO_SWAP"),
    com_knob_large_inc=msfs.event_sender("COM_RADIO_WHOLE_INC"),
    com_knob_large_dec=msfs.event_sender("COM_RADIO_WHOLE_DEC"),
    com_knob_small_inc=msfs.event_sender("COM_RADIO_FRACT_INC"),
    com_knob_small_dec=msfs.event_sender("COM_RADIO_FRACT_DEC"),
    com_swap=msfs.event_sender("COM1_RADIO_SWAP"),
}
module.actions[2] = {
    nav_knob_large_inc=msfs.event_sender("NAV2_RADIO_WHOLE_INC"),
    nav_knob_large_dec=msfs.event_sender("NAV2_RADIO_WHOLE_DEC"),
    nav_knob_small_inc=msfs.event_sender("NAV2_RADIO_FRACT_INC"),
    nav_knob_small_dec=msfs.event_sender("NAV2_RADIO_FRACT_DEC"),
    nav_swap=msfs.event_sender("NAV2_RADIO_SWAP"),
    com_knob_large_inc=msfs.event_sender("COM2_RADIO_WHOLE_INC"),
    com_knob_large_dec=msfs.event_sender("COM2_RADIO_WHOLE_DEC"),
    com_knob_small_inc=msfs.event_sender("COM2_RADIO_FRACT_INC"),
    com_knob_small_dec=msfs.event_sender("COM2_RADIO_FRACT_DEC"),
    com_swap=msfs.event_sender("COM2_RADIO_SWAP"),
}
