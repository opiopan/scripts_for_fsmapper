...
module.actions = {}
module.actions[1] = {
    rng_zoom = msfs.mfwasm.rpn_executer("(>H:AS3X_1_RNG_Zoom)"),
    rng_dezoom = msfs.mfwasm.rpn_executer("(>H:AS3X_1_RNG_Dezoom)"),
    turn_inc = msfs.mfwasm.rpn_executer("(>H:AS3X_1_TURN_INC)"),
    turn_dec = msfs.mfwasm.rpn_executer("(>H:AS3X_1_TURN_DEC)"),
    joystick_left = msfs.mfwasm.rpn_executer("(>H:AS3X_1_JOYSTICK_LEFT)"),
    joystick_right = msfs.mfwasm.rpn_executer("(>H:AS3X_1_JOYSTICK_RIGHT)"),
    joystick_up = msfs.mfwasm.rpn_executer("(>H:AS3X_1_JOYSTICK_UP)"),
    joystick_down = msfs.mfwasm.rpn_executer("(>H:AS3X_1_JOYSTICK_DOWN)"),
    joystick_push = msfs.mfwasm.rpn_executer("(>H:AS3X_1_JOYSTICK_PUSH)"),
    ent = msfs.mfwasm.rpn_executer("(>H:AS3X_1_ENT_Push)"),
    clr = msfs.mfwasm.rpn_executer("(>H:AS3X_1_CLR_Push)"),
    menu = msfs.mfwasm.rpn_executer("(>H:AS3X_1_MENU_Push)"),
    fpl = msfs.mfwasm.rpn_executer("(>H:AS3X_1_FPL_Push)"),
    directto = msfs.mfwasm.rpn_executer("(>H:AS3X_1_DIRECTTO)"),
    nrst = msfs.mfwasm.rpn_executer("(>H:AS3X_1_NRST_Push)"),
    softkey1 = msfs.mfwasm.rpn_executer("(>H:AS3X_1_SOFTKEYS_1)"),
    softkey2 = msfs.mfwasm.rpn_executer("(>H:AS3X_1_SOFTKEYS_2)"),
    softkey3 = msfs.mfwasm.rpn_executer("(>H:AS3X_1_SOFTKEYS_3)"),
    softkey4 = msfs.mfwasm.rpn_executer("(>H:AS3X_1_SOFTKEYS_4)"),
    softkey5 = msfs.mfwasm.rpn_executer("(>H:AS3X_1_SOFTKEYS_5)"),
}

module.actions[2] = {
    rng_zoom = msfs.mfwasm.rpn_executer("(>H:AS3X_2_RNG_Zoom)"),
    rng_dezoom = msfs.mfwasm.rpn_executer("(>H:AS3X_2_RNG_Dezoom)"),
    turn_inc = msfs.mfwasm.rpn_executer("(>H:AS3X_2_TURN_INC)"),
    turn_dec = msfs.mfwasm.rpn_executer("(>H:AS3X_2_TURN_DEC)"),
    joystick_left = msfs.mfwasm.rpn_executer("(>H:AS3X_2_JOYSTICK_LEFT)"),
    joystick_right = msfs.mfwasm.rpn_executer("(>H:AS3X_2_JOYSTICK_RIGHT)"),
    joystick_up = msfs.mfwasm.rpn_executer("(>H:AS3X_2_JOYSTICK_UP)"),
    joystick_down = msfs.mfwasm.rpn_executer("(>H:AS3X_2_JOYSTICK_DOWN)"),
    joystick_push = msfs.mfwasm.rpn_executer("(>H:AS3X_2_JOYSTICK_PUSH)"),
    ent = msfs.mfwasm.rpn_executer("(>H:AS3X_2_ENT_Push)"),
    clr = msfs.mfwasm.rpn_executer("(>H:AS3X_2_CLR_Push)"),
    menu = msfs.mfwasm.rpn_executer("(>H:AS3X_2_MENU_Push)"),
    fpl = msfs.mfwasm.rpn_executer("(>H:AS3X_2_FPL_Push)"),
    directto = msfs.mfwasm.rpn_executer("(>H:AS3X_2_DIRECTTO)"),
    nrst = msfs.mfwasm.rpn_executer("(>H:AS3X_2_NRST_Push)"),
    softkey1 = msfs.mfwasm.rpn_executer("(>H:AS3X_2_SOFTKEYS_1)"),
    softkey2 = msfs.mfwasm.rpn_executer("(>H:AS3X_2_SOFTKEYS_2)"),
    softkey3 = msfs.mfwasm.rpn_executer("(>H:AS3X_2_SOFTKEYS_3)"),
    softkey4 = msfs.mfwasm.rpn_executer("(>H:AS3X_2_SOFTKEYS_4)"),
    softkey5 = msfs.mfwasm.rpn_executer("(>H:AS3X_2_SOFTKEYS_5)"),
}
