...
--------------------------------------------------------------------------------------
module.actions[1] = {
    left = msfs.mfwasm.rpn_executer("(>H:ASVigilus_push_left)"),
    right = msfs.mfwasm.rpn_executer("(>H:ASVigilus_push_right)"),
    knob_inc = msfs.mfwasm.rpn_executer("(>H:ASVigilus_knob_Inc)"),
    knob_dec = msfs.mfwasm.rpn_executer("(>H:ASVigilus_knob_Dec)"),
    knob_push = msfs.mfwasm.rpn_executer("(>H:ASVigilus_knob_Push)"),
}
--------------------------------------------------------------------------------------
