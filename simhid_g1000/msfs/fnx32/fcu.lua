...
--------------------------------------------------------------------------------------
local view_mappings = {
    {event=events.spdmach_push, action=msfs.mfwasm.rpn_executer("(L:S_FCU_SPD_MACH) 2 + (>L:S_FCU_SPD_MACH)")},
    {event=events.loc_push, action=msfs.mfwasm.rpn_executer("(L:S_FCU_LOC) 2 + (>L:S_FCU_LOC)")},
    {event=events.hdgtrk_push, action=msfs.mfwasm.rpn_executer("(L:S_FCU_HDGVS_TRKFPA) 2 + (>L:S_FCU_HDGVS_TRKFPA)")},
    {event=events.ap1_push, action=msfs.mfwasm.rpn_executer("(L:S_FCU_AP1) 2 + (>L:S_FCU_AP1)")},
    {event=events.ap2_push, action=msfs.mfwasm.rpn_executer("(L:S_FCU_AP2) 2 + (>L:S_FCU_AP2)")},
    {event=events.athr_push, action=msfs.mfwasm.rpn_executer("(L:S_FCU_ATHR) 2 + (>L:S_FCU_ATHR)")},
    {event=events.exped_push, action=msfs.mfwasm.rpn_executer("(L:S_FCU_EXPED) 2 + (>L:S_FCU_EXPED)")},
    {event=events.metricalt_push, action=msfs.mfwasm.rpn_executer("(L:S_FCU_METRIC_ALT) 2 + (>L:S_FCU_METRIC_ALT)")},
    {event=events.appr_push, action=msfs.mfwasm.rpn_executer("(L:S_FCU_APPR) 2 + (>L:S_FCU_APPR)")},
    {event=events.fd_push, action=msfs.mfwasm.rpn_executer("(L:S_FCU_EFIS1_FD) 2 + (>L:S_FCU_EFIS1_FD)")},
    {event=events.ls_push, action=msfs.mfwasm.rpn_executer("(L:S_FCU_EFIS1_LS) 2 + (>L:S_FCU_EFIS1_LS)")},
    {event=events.hghpa_push, action=msfs.mfwasm.rpn_executer("(L:S_FCU_EFIS1_BARO_MODE) 0 == if{ 1 (>L:S_FCU_EFIS1_BARO_MODE) } els{ 0 (>L:S_FCU_EFIS1_BARO_MODE) }")},
}
