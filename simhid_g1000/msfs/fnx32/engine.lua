...
--------------------------------------------------------------------------------------
local view_mappings = {
    {event=events.master1_up, action=msfs.mfwasm.rpn_executer("1 (>L:S_ENG_MASTER_1)")},
    {event=events.master1_down, action=msfs.mfwasm.rpn_executer("0 (>L:S_ENG_MASTER_1)")},
    {event=events.master2_up, action=msfs.mfwasm.rpn_executer("1 (>L:S_ENG_MASTER_2)")},
    {event=events.master2_down, action=msfs.mfwasm.rpn_executer("0 (>L:S_ENG_MASTER_2)")},
    {event=events.mode_left, action=msfs.mfwasm.rpn_executer("(L:S_ENG_MODE) -- 0 max (>L:S_ENG_MODE)")},
    {event=events.mode_right, action=msfs.mfwasm.rpn_executer("(L:S_ENG_MODE) ++ 2 min (>L:S_ENG_MODE)")},
    {event=events.apumaster_push, action=msfs.mfwasm.rpn_executer("(L:S_OH_ELEC_APU_MASTER) ! (>L:S_OH_ELEC_APU_MASTER)")},
    {event=events.apustart_push, action=filter.duplicator(
        msfs.mfwasm.rpn_executer("1 (>L:S_OH_ELEC_APU_START)"),
        filter.delay(100, msfs.mfwasm.rpn_executer("0 (>L:S_OH_ELEC_APU_START)"))
    )},
    {event=events.apubleed_push, action=msfs.mfwasm.rpn_executer("(L:S_OH_PNEUMATIC_APU_BLEED) ! (>L:S_OH_PNEUMATIC_APU_BLEED)")},
    {event=events.bat1_push, action=msfs.mfwasm.rpn_executer("(L:S_OH_ELEC_BAT1) ! (>L:S_OH_ELEC_BAT1)")},
    {event=events.bat2_push, action=msfs.mfwasm.rpn_executer("(L:S_OH_ELEC_BAT2) ! (>L:S_OH_ELEC_BAT2)")},
    {event=events.extpwr_push, action=filter.duplicator(
        msfs.mfwasm.rpn_executer("(L:S_OH_ELEC_EXT_PWR) ! (>L:S_OH_ELEC_EXT_PWR)"),
        filter.delay(100, msfs.mfwasm.rpn_executer("(L:S_OH_ELEC_EXT_PWR) ! (>L:S_OH_ELEC_EXT_PWR)"))
    )},
}
