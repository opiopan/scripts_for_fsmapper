...
--------------------------------------------------------------------------------------
local view_mappings = {
    {event=events.cstr_push, action=msfs.mfwasm.rpn_executer("(L:S_FCU_EFIS1_CSTR) 2 + (>L:S_FCU_EFIS1_CSTR)")},
    {event=events.wpt_push, action=msfs.mfwasm.rpn_executer("(L:S_FCU_EFIS1_WPT) 2 + (>L:S_FCU_EFIS1_WPT)")},
    {event=events.vord_push, action=msfs.mfwasm.rpn_executer("(L:S_FCU_EFIS1_VORD) 2 + (>L:S_FCU_EFIS1_VORD)")},
    {event=events.ndb_push, action=msfs.mfwasm.rpn_executer("(L:S_FCU_EFIS1_NDB) 2 + (>L:S_FCU_EFIS1_NDB)")},
    {event=events.aprt_push, action=msfs.mfwasm.rpn_executer("(L:S_FCU_EFIS1_ARPT) 2 + (>L:S_FCU_EFIS1_ARPT)")},
    {event=events.adfvor1_left, action=msfs.mfwasm.rpn_executer("(L:S_FCU_EFIS1_NAV1) -- 0 max (>L:S_FCU_EFIS1_NAV1)")},
    {event=events.adfvor1_right, action=msfs.mfwasm.rpn_executer("(L:S_FCU_EFIS1_NAV1) ++ 2 min (>L:S_FCU_EFIS1_NAV1)")},
    {event=events.adfvor2_left, action=msfs.mfwasm.rpn_executer("(L:S_FCU_EFIS1_NAV2) -- 0 max (>L:S_FCU_EFIS1_NAV2)")},
    {event=events.adfvor2_right, action=msfs.mfwasm.rpn_executer("(L:S_FCU_EFIS1_NAV2) ++ 2 min (>L:S_FCU_EFIS1_NAV2)")},
    {event=events.brklo_push, action=msfs.mfwasm.rpn_executer("(L:S_MIP_AUTOBRAKE_LO) 2 + (>L:S_MIP_AUTOBRAKE_LO)")},
    {event=events.brkmed_push, action=msfs.mfwasm.rpn_executer("(L:S_MIP_AUTOBRAKE_MED) 2 + (>L:S_MIP_AUTOBRAKE_MED)")},
    {event=events.brkmax_push, action=msfs.mfwasm.rpn_executer("(L:S_MIP_AUTOBRAKE_MAX) 2 + (>L:S_MIP_AUTOBRAKE_MAX)")},
    {event=events.terronnd_push, action=msfs.mfwasm.rpn_executer("(L:S_MIP_GPWS_TERRAIN_ON_ND_CAPT) 2 + (>L:S_MIP_GPWS_TERRAIN_ON_ND_CAPT)")},
    {event=events.chrono_push, action=msfs.mfwasm.rpn_executer("(L:S_MIP_CHRONO_CAPT) 2 + (>L:S_MIP_CHRONO_CAPT)")},
}
