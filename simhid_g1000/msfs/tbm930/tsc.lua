...
local buttons = {
    {x=1152, y=244 + button_size.height * 0, evid=mapper.register_event("TMB930 TSC:SOFT1"), action=msfs.mfwasm.rpn_executer("(>H:AS3000_TSC_Horizontal_1_SoftKey_1) 1 (>O:_ButtonAnimVar)")},
    {x=1152, y=244 + button_size.height * 1, evid=mapper.register_event("TMB930 TSC:SOFT2"), action=msfs.mfwasm.rpn_executer("(>H:AS3000_TSC_Horizontal_1_SoftKey_2) 1 (>O:_ButtonAnimVar)")},
    {x=1152, y=244 + button_size.height * 2, evid=mapper.register_event("TMB930 TSC:SOFT3"), action=msfs.mfwasm.rpn_executer("(>H:AS3000_TSC_Horizontal_1_SoftKey_3) 1 (>O:_ButtonAnimVar)")},
}
