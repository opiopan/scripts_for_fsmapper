...
function module.start(config, aircraft)
    ...
    local pfd_mappings = {
        {event=g1000.EC5.increment, action=msfs.mfwasm.rpn_executer("(>H:AS3000_TSC_Vertical_1_MiddleKnob_INC)")},
        {event=g1000.EC5.decrement, action=msfs.mfwasm.rpn_executer("(>H:AS3000_TSC_Vertical_1_MiddleKnob_DEC)")},
        {event=g1000.EC5P.up, action=msfs.mfwasm.rpn_executer("(>H:AS3000_TSC_Vertical_1_MiddleKnob_Push)")},
        {event=g1000.EC8.increment, action=msfs.mfwasm.rpn_executer("(>H:AS3000_TSC_Vertical_1_Joystick_INC)")},
        {event=g1000.EC8.decrement, action=msfs.mfwasm.rpn_executer("(>H:AS3000_TSC_Vertical_1_Joystick_DEC)")},
        {event=g1000.EC8P.up, action=msfs.mfwasm.rpn_executer("(>H:AS3000_TSC_Vertical_1_Joystick_Push)")},
        {event=g1000.EC8U.down, action=msfs.mfwasm.rpn_executer("(>H:AS3000_TSC_Vertical_1_Joystick_Up)")},
        {event=g1000.EC8D.down, action=msfs.mfwasm.rpn_executer("(>H:AS3000_TSC_Vertical_1_Joystick_Down)")},
        {event=g1000.EC8L.down, action=msfs.mfwasm.rpn_executer("(>H:AS3000_TSC_Vertical_1_Joystick_Left)")},
        {event=g1000.EC8R.down, action=msfs.mfwasm.rpn_executer("(>H:AS3000_TSC_Vertical_1_Joystick_Right)")},
        {event=g1000.EC6Y.increment, action=msfs.mfwasm.rpn_executer("(>H:AS3000_TSC_Vertical_1_RightKnob_Large_INC)")},
        {event=g1000.EC6Y.decrement, action=msfs.mfwasm.rpn_executer("(>H:AS3000_TSC_Vertical_1_RightKnob_Large_DEC)")},
        {event=g1000.EC6X.increment, action=msfs.mfwasm.rpn_executer("(>H:AS3000_TSC_Vertical_1_RightKnob_Small_INC)")},
        {event=g1000.EC6X.decrement, action=msfs.mfwasm.rpn_executer("(>H:AS3000_TSC_Vertical_1_RightKnob_Small_DEC)")},
        {event=g1000.EC6P.up, action=msfs.mfwasm.rpn_executer("(>H:AS3000_TSC_Vertical_1_RightKnob_Push)")},
        {event=g1000.EC6P.longpressed, action=msfs.mfwasm.rpn_executer("(>H:AS3000_TSC_Vertical_1_RightKnob_Push_Long)")},
    }
    local mfd_gtc_is_left = true
    local execute_gtc_rpn = function (suffix)
        msfs.mfwasm.execute_rpn("(>H:AS3000_TSC_Vertical_" .. (mfd_gtc_is_left and "2" or "3") .. suffix)
    end
    local mfd_mappings = {
