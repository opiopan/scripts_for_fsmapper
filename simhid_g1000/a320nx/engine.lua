...
local observed_data = {
    ...
    {rpn="(L:A32NX_OVHD_ELEC_BAT_1_PB_IS_AUTO) !", event=events.bat1l_change},
    {rpn="(L:A32NX_OVHD_ELEC_BAT_1_PB_HAS_FAULT)", event=events.bat1u_change},
    {rpn="(L:A32NX_OVHD_ELEC_BAT_2_PB_IS_AUTO) !", event=events.bat2l_change},
...
local view_mappings = {
    ...
    -- {event=events.apumaster_push, action=fs2020.event_sender("MobiFlight.A32NX_APU_MASTER")},
    ...
    -- {event=events.bat2_push, action=fs2020.event_sender("MobiFlight.A32NX_OH_ELEC_BAT2_TOG")},
