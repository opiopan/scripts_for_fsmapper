...
local views = {
    {
        ...
        background_regions = {
            ...
            {x=0, y=1475, width=2224, height=193},
            {x=0, y=0, width=556, height=1668},
            {x=1668, y=0, width=556, height=1668},
        },
        components = {
            {name="gns530", module=libs.gns530, cw="gns530", type_id=1, x=556, y=193, scale=1, instance=nil},
            {name="gns430", module=libs.gns430, cw="gns430", type_id=1, x=556, y=1009, scale=1, instance=nil},
        },
        mappings = {},
