...
local function start(config)
    ...
    local mappings = {
        ...
        {event=g1000.EC1.increment, action=fs2020.mfwasm.rpn_executer('(L:E_FCU_SPEED) ++ (>L:E_FCU_SPEED)')},
        {event=g1000.EC1.decrement, action=fs2020.mfwasm.rpn_executer('(L:E_FCU_SPEED) -- (>L:E_FCU_SPEED)')},
        {event=g1000.EC1P.up, action=fs2020.mfwasm.rpn_executer('(L:S_FCU_SPEED) -- (>L:S_FCU_SPEED)')},
        {event=g1000.EC1P.longpressed, action=fs2020.mfwasm.rpn_executer('(L:S_FCU_SPEED) ++ (>L:S_FCU_SPEED)')},
        {event=g1000.SW1.down, action=fs2020.mfwasm.rpn_executer('(L:S_FCU_SPEED) ++ (>L:S_FCU_SPEED)')},
        {event=g1000.EC3.increment, action=fs2020.mfwasm.rpn_executer('(L:E_FCU_HEADING) ++ (>L:E_FCU_HEADING)')},
        {event=g1000.EC3.decrement, action=fs2020.mfwasm.rpn_executer('(L:E_FCU_HEADING) -- (>L:E_FCU_HEADING)')},
        {event=g1000.EC3P.up, action=fs2020.mfwasm.rpn_executer('(L:S_FCU_HEADING) -- (>L:S_FCU_HEADING)')},
        {event=g1000.EC3P.longpressed, action=fs2020.mfwasm.rpn_executer('(L:S_FCU_HEADING) ++ (>L:S_FCU_HEADING)')},
        {event=g1000.SW4.down, action=fs2020.mfwasm.rpn_executer('(L:S_FCU_HEADING) ++ (>L:S_FCU_HEADING)')},
        {event=g1000.EC4X.increment, action=fs2020.mfwasm.rpn_executer('(L:E_FCU_ALTITUDE) ++ (>L:E_FCU_ALTITUDE)')},
        {event=g1000.EC4X.decrement, action=fs2020.mfwasm.rpn_executer('(L:E_FCU_ALTITUDE) -- (>L:E_FCU_ALTITUDE)')},
        {event=g1000.EC4Y.increment, action=fs2020.mfwasm.rpn_executer('1 (>L:S_FCU_ALTITUDE_SCALE)')},
        {event=g1000.EC4Y.decrement, action=fs2020.mfwasm.rpn_executer('0 (>L:S_FCU_ALTITUDE_SCALE)')},
        {event=g1000.EC4P.up, action=fs2020.mfwasm.rpn_executer('(L:S_FCU_ALTITUDE) -- (>L:S_FCU_ALTITUDE)')},
        {event=g1000.EC4P.longpressed, action=fs2020.mfwasm.rpn_executer('(L:S_FCU_ALTITUDE) ++ (>L:S_FCU_ALTITUDE)')},
        {event=g1000.SW12.down, action=fs2020.mfwasm.rpn_executer('(L:S_FCU_ALTITUDE) ++ (>L:S_FCU_ALTITUDE)')},
        {event=g1000.EC5.increment, action=fs2020.mfwasm.rpn_executer('(L:E_FCU_VS) ++ (>L:E_FCU_VS)')},
        {event=g1000.EC5.decrement, action=fs2020.mfwasm.rpn_executer('(L:E_FCU_VS) -- (>L:E_FCU_VS)')},
        {event=g1000.EC5P.up, action=fs2020.mfwasm.rpn_executer('(L:S_FCU_VERTICAL_SPEED) -- (>L:S_FCU_VERTICAL_SPEED)')},
        {event=g1000.EC5P.longpressed, action=fs2020.mfwasm.rpn_executer('(L:S_FCU_VERTICAL_SPEED) ++ (>L:S_FCU_VERTICAL_SPEED)')},
        {event=g1000.SW26.down, action=fs2020.mfwasm.rpn_executer('(L:S_FCU_VERTICAL_SPEED) ++ (>L:S_FCU_VERTICAL_SPEED)')},
        {event=g1000.SW2.down, action=fs2020.mfwasm.rpn_executer('(L:S_FCU_AP1) ++ (>L:S_FCU_AP1)')},
        {event=g1000.SW2.up, action=fs2020.mfwasm.rpn_executer('(L:S_FCU_AP1) ++ (>L:S_FCU_AP1)')},
        {event=g1000.SW3.down, action=fs2020.mfwasm.rpn_executer('(L:S_FCU_EFIS1_FD) ++ (>L:S_FCU_EFIS1_FD)')},
        {event=g1000.SW3.up, action=fs2020.mfwasm.rpn_executer('(L:S_FCU_EFIS1_FD) ++ (>L:S_FCU_EFIS1_FD)')},
        {event=g1000.SW8.down, action=fs2020.mfwasm.rpn_executer('(L:S_FCU_APPR) ++ (>L:S_FCU_APPR)')},
        {event=g1000.SW8.up, action=fs2020.mfwasm.rpn_executer('(L:S_FCU_APPR) ++ (>L:S_FCU_APPR)')},

        {event=g1000.EC8.increment, action=fs2020.mfwasm.rpn_executer('(L:S_FCU_EFIS1_ND_ZOOM) ++ 5 min (>L:S_FCU_EFIS1_ND_ZOOM)')},
        {event=g1000.EC8.decrement, action=fs2020.mfwasm.rpn_executer('(L:S_FCU_EFIS1_ND_ZOOM) -- 0 max (>L:S_FCU_EFIS1_ND_ZOOM)')},
        {event=g1000.EC8L.down, action=fs2020.mfwasm.rpn_executer('(L:S_FCU_EFIS1_ND_MODE) -- 0 max (>L:S_FCU_EFIS1_ND_MODE)')},
        {event=g1000.EC8U.down, action=fs2020.mfwasm.rpn_executer('(L:S_FCU_EFIS1_ND_MODE) -- 0 max (>L:S_FCU_EFIS1_ND_MODE)')},
        {event=g1000.EC8R.down, action=fs2020.mfwasm.rpn_executer('(L:S_FCU_EFIS1_ND_MODE) ++ 4 min (>L:S_FCU_EFIS1_ND_MODE)')},
        {event=g1000.EC8D.down, action=fs2020.mfwasm.rpn_executer('(L:S_FCU_EFIS1_ND_MODE) ++ 4 min (>L:S_FCU_EFIS1_ND_MODE)')},

        {event=g1000.EC6X.increment, action=fs2020.mfwasm.rpn_executer('(L:E_PED_RMP1_INNER) ++ (>L:E_PED_RMP1_INNER)')},
        {event=g1000.EC6X.decrement, action=fs2020.mfwasm.rpn_executer('(L:E_PED_RMP1_INNER) -- (>L:E_PED_RMP1_INNER)')},
        {event=g1000.EC6Y.increment, action=fs2020.mfwasm.rpn_executer('(L:E_PED_RMP1_OUTER) ++ (>L:E_PED_RMP1_OUTER)')},
        {event=g1000.EC6Y.decrement, action=fs2020.mfwasm.rpn_executer('(L:E_PED_RMP1_OUTER) -- (>L:E_PED_RMP1_OUTER)')},
        {event=g1000.EC6P.down, action=fs2020.mfwasm.rpn_executer('(L:S_PED_RMP1_XFER) ++ (>L:S_PED_RMP1_XFER)')},
        {event=g1000.EC6P.up, action=fs2020.mfwasm.rpn_executer('(L:S_PED_RMP1_XFER) ++ (>L:S_PED_RMP1_XFER)')},

        {event=g1000.EC7Y.increment, action=fs2020.mfwasm.rpn_executer('(L:E_FCU_EFIS1_BARO) ++ (>L:E_FCU_EFIS1_BARO)')},
        {event=g1000.EC7Y.decrement, action=fs2020.mfwasm.rpn_executer('(L:E_FCU_EFIS1_BARO) -- (>L:E_FCU_EFIS1_BARO)')},
        {event=g1000.EC7P.down, action=fs2020.mfwasm.rpn_executer('(L:B_FCU_EFIS1_BARO_STD) if{ (L:S_FCU_EFIS1_BARO_STD) -- (>L:S_FCU_EFIS1_BARO_STD) } els{ (L:S_FCU_EFIS1_BARO_STD) ++ (>L:S_FCU_EFIS1_BARO_STD) } ')},
