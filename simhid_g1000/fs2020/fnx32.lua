...
local function start(config)
    ...
    local mappings = {
        ...
        {event=g1000.EC1.increment, action=fs2020.event_sender("MobiFlight.FNX320_FCU_SPEED_KNOB_INC")},
        {event=g1000.EC1.decrement, action=fs2020.event_sender("MobiFlight.FNX320_FCU_SPEED_KNOB_DEC")},
        {event=g1000.EC1P.down, action=fs2020.event_sender("MobiFlight.FNX320_FCU_SPEED_KNOB_PUSH")},
        {event=g1000.SW1.down, action=fs2020.event_sender("MobiFlight.FNX320_FCU_SPEED_KNOB_PULL")},
        {event=g1000.EC3.increment, action=fs2020.event_sender("MobiFlight.FNX320_FCU_HEADING_KNOB_INC")},
        {event=g1000.EC3.decrement, action=fs2020.event_sender("MobiFlight.FNX320_FCU_HEADING_KNOB_DEC")},
        {event=g1000.EC3P.down, action=fs2020.event_sender("MobiFlight.FNX320_FCU_HEADING_KNOB_PUSH")},
        {event=g1000.SW4.down, action=fs2020.event_sender("MobiFlight.FNX320_FCU_HEADING_KNOB_PULL")},
        {event=g1000.EC4X.increment, action=fs2020.event_sender("MobiFlight.FNX320_FCU_ALTITUDE_KNOB_INC")},
        {event=g1000.EC4X.decrement, action=fs2020.event_sender("MobiFlight.FNX320_FCU_ALTITUDE_KNOB_DEC")},
        {event=g1000.EC4Y.increment, action=fs2020.event_sender("MobiFlight.FNX320_FCU_ALTITUDE_SCALE_1000")},
        {event=g1000.EC4Y.decrement, action=fs2020.mfwasm.rpn_executer("MobiFlight.FNX320_FCU_ALTITUDE_SCALE_100")},
        {event=g1000.EC4P.down, action=fs2020.event_sender("MobiFlight.FNX320_FCU_ALTITUDE_KNOB_PUSH")},
        {event=g1000.SW12.down, action=fs2020.event_sender("MobiFlight.FNX320_FCU_ALTITUDE_KNOB_PULL")},
        {event=g1000.EC5.increment, action=fs2020.event_sender("MobiFlight.FNX320_FCU_VS_KNOB_INC")},
        {event=g1000.EC5.decrement, action=fs2020.event_sender("MobiFlight.FNX320_FCU_VS_KNOB_DEC")},
        {event=g1000.EC5P.down, action=fs2020.event_sender("MobiFlight.FNX320_FCU_VS_KNOB_PUSH")},
        {event=g1000.SW26.down, action=fs2020.event_sender("MobiFlight.FNX320_FCU_VS_KNOB_PULL")},
        {event=g1000.SW2.down, action=fs2020.event_sender("MobiFlight.FNX320_FCU_AP1_PUSH")},
        {event=g1000.SW2.up, action=fs2020.event_sender("MobiFlight.FNX320_FCU_AP1_RELEASE")},
        {event=g1000.SW3.down, action=fs2020.event_sender("MobiFlight.FNX320_FCU_EFIS1_FD_PUSH")},
        {event=g1000.SW3.up, action=fs2020.event_sender("MobiFlight.FNX320_FCU_EFIS1_FD_RELEASE")},
        {event=g1000.SW8.down, action=fs2020.event_sender("MobiFlight.FNX320_FCU_APPR_PUSH")},
        {event=g1000.SW8.up, action=fs2020.event_sender("MobiFlight.FNX320_FCU_APPR_RELEASE")},

        {event=g1000.EC8.increment, action=fs2020.event_sender("MobiFlight.FNX320_EFIS_L_ND_RANGE_INC")},
        {event=g1000.EC8.decrement, action=fs2020.event_sender("MobiFlight.FNX320_EFIS_L_ND_RANGE_DEC")},
        {event=g1000.EC8L.down, action=fs2020.event_sender("MobiFlight.FNX320_EFIS_L_ND_MODE_DEC")},
        {event=g1000.EC8U.down, action=fs2020.event_sender("MobiFlight.FNX320_EFIS_L_ND_MODE_DEC")},
        {event=g1000.EC8R.down, action=fs2020.event_sender("MobiFlight.FNX320_EFIS_L_ND_MODE_INC")},
        {event=g1000.EC8D.down, action=fs2020.event_sender("MobiFlight.FNX320_EFIS_L_ND_MODE_INC")},

        {event=g1000.EC6X.increment, action=fs2020.event_sender("MobiFlight.FNX32_RADIO_1_INNER_KNOB_INC")},
        {event=g1000.EC6X.decrement, action=fs2020.event_sender("MobiFlight.FNX32_RADIO_1_INNER_KNOB_DEC")},
        {event=g1000.EC6Y.increment, action=fs2020.event_sender("MobiFlight.FNX32_RADIO_1_OUTER_KNOB_INC")},
        {event=g1000.EC6Y.decrement, action=fs2020.event_sender("MobiFlight.FNX32_RADIO_1_OUTER_KNOB_INC")},
        {event=g1000.EC6P.down, action=fs2020.event_sender("MobiFlight.FNX320_RADIO_1_XFER_PUSH")},
        {event=g1000.EC6P.up, action=fs2020.event_sender("MobiFlight.FNX320_RADIO_1_XFER_RELEASE")},

        {event=g1000.EC7Y.increment, action=fs2020.event_sender("Mobiflight.FNX320_EFIS_L_BARO_KNOB_INC")},
        {event=g1000.EC7Y.decrement, action=fs2020.event_sender("Mobiflight.FNX320_EFIS_L_BARO_KNOB_DEC")},
        {event=g1000.EC7P.down, action=fs2020.event_sender("Mobiflight.FNX320_EFIS_L_BARO_STD_TOG")},
