...
context.actions = {}
context.actions[1] = {
    nrst = fs2020.mfwasm.rpn_executer("(>H:AS3X_Touch_1_NRST_Push)"),
    direct_to = fs2020.mfwasm.rpn_executer("(>H:AS3X_Touch_1_DirectTo_Push)"),
    menu = fs2020.mfwasm.rpn_executer("(>H:AS3X_Touch_1_Menu_Push)"),
    back = fs2020.mfwasm.rpn_executer("(>H:AS3X_Touch_1_Back_Push)"),
    lknob_inner_inc = fs2020.mfwasm.rpn_executer("(>H:AS3X_Touch_1_Knob_Inner_L_INC)"),
    lknob_inner_dec = fs2020.mfwasm.rpn_executer("(>H:AS3X_Touch_1_Knob_Inner_L_DEC)"),
    lknob_outer_inc = fs2020.mfwasm.rpn_executer("(>H:AS3X_Touch_1_Knob_Outer_L_INC)"),
    lknob_outer_dec = fs2020.mfwasm.rpn_executer("(>H:AS3X_Touch_1_Knob_Outer_L_DEC)"),
    rknob_inner_inc = fs2020.mfwasm.rpn_executer("(>H:AS3X_Touch_1_Knob_Inner_R_INC)"),
    rknob_inner_dec = fs2020.mfwasm.rpn_executer("(>H:AS3X_Touch_1_Knob_Inner_R_DEC)"),
    rknob_outer_inc = fs2020.mfwasm.rpn_executer("(>H:AS3X_Touch_1_Knob_Outer_R_INC)"),
    rknob_outer_dec = fs2020.mfwasm.rpn_executer("(>H:AS3X_Touch_1_Knob_Outer_R_DEC)"),
}
context.actions[2] = {
    nrst = fs2020.mfwasm.rpn_executer("(>H:AS3X_Touch_2_NRST_Push)"),
    direct_to = fs2020.mfwasm.rpn_executer("(>H:AS3X_Touch_2_DirectTo_Push)"),
    menu = fs2020.mfwasm.rpn_executer("(>H:AS3X_Touch_2_Menu_Push)"),
    back = fs2020.mfwasm.rpn_executer("(>H:AS3X_Touch_2_Back_Push)"),
    lknob_inner_inc = fs2020.mfwasm.rpn_executer("(>H:AS3X_Touch_2_Knob_Inner_L_INC)"),
    lknob_inner_dec = fs2020.mfwasm.rpn_executer("(>H:AS3X_Touch_2_Knob_Inner_L_DEC)"),
    lknob_outer_inc = fs2020.mfwasm.rpn_executer("(>H:AS3X_Touch_2_Knob_Outer_L_INC)"),
    lknob_outer_dec = fs2020.mfwasm.rpn_executer("(>H:AS3X_Touch_2_Knob_Outer_L_DEC)"),
    rknob_inner_inc = fs2020.mfwasm.rpn_executer("(>H:AS3X_Touch_2_Knob_Inner_R_INC)"),
    rknob_inner_dec = fs2020.mfwasm.rpn_executer("(>H:AS3X_Touch_2_Knob_Inner_R_DEC)"),
    rknob_outer_inc = fs2020.mfwasm.rpn_executer("(>H:AS3X_Touch_2_Knob_Outer_R_INC)"),
    rknob_outer_dec = fs2020.mfwasm.rpn_executer("(>H:AS3X_Touch_2_Knob_Outer_R_DEC)"),
}
