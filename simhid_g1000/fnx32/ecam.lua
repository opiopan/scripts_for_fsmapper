...
--------------------------------------------------------------------------------------
local view_mappings = {
    {event=events.toconfig_push, action=fs2020.mfwasm.rpn_executer("(L:S_ECAM_TO) 2 + (>L:S_ECAM_TO)")},
    {event=events.eng_push, action=fs2020.mfwasm.rpn_executer("(L:S_ECAM_ENGINE) 2 + (>L:S_ECAM_ENGINE)")},
    {event=events.bleed_push, action=fs2020.mfwasm.rpn_executer("(L:S_ECAM_BLEED) 2 + (>L:S_ECAM_BLEED)")},
    {event=events.press_push, action=fs2020.mfwasm.rpn_executer("(L:S_ECAM_CAB_PRESS) 2 + (>L:S_ECAM_CAB_PRESS)")},
    {event=events.elec_push, action=fs2020.mfwasm.rpn_executer("(L:S_ECAM_ELEC) 2 + (>L:S_ECAM_ELEC)")},
    {event=events.hyd_push, action=fs2020.mfwasm.rpn_executer("(L:S_ECAM_HYD) 2 + (>L:S_ECAM_HYD)")},
    {event=events.fuel_push, action=fs2020.mfwasm.rpn_executer("(L:S_ECAM_FUEL) 2 + (>L:S_ECAM_FUEL)")},
    {event=events.apu_push, action=fs2020.mfwasm.rpn_executer("(L:S_ECAM_APU) 2 + (>L:S_ECAM_APU)")},
    {event=events.cond_push, action=fs2020.mfwasm.rpn_executer("(L:S_ECAM_COND) 2 + (>L:S_ECAM_COND)")},
    {event=events.door_push, action=fs2020.mfwasm.rpn_executer("(L:S_ECAM_DOOR) 2 + (>L:S_ECAM_DOOR)")},
    {event=events.wheel_push, action=fs2020.mfwasm.rpn_executer("(L:S_ECAM_WHEEL) 2 + (>L:S_ECAM_WHEEL)")},
    {event=events.fctl_push, action=fs2020.mfwasm.rpn_executer("(L:S_ECAM_FCTL) 2 + (>L:S_ECAM_FCTL)")},
    {event=events.sts_push, action=fs2020.mfwasm.rpn_executer("(L:S_ECAM_STATUS) 2 + (>L:S_ECAM_STATUS)")},
    {event=events.rcl_push, action=fs2020.mfwasm.rpn_executer("(L:S_ECAM_RCL) 2 + (>L:S_ECAM_RCL)")},
    {event=events.lclr_push, action=fs2020.mfwasm.rpn_executer("(L:S_ECAM_CLR_LEFT) 2 + (>L:S_ECAM_CLR_LEFT)")},
    {event=events.rclr_push, action=fs2020.mfwasm.rpn_executer("(L:S_ECAM_CLR_RIGHT) 2 + (>L:S_ECAM_CLR_RIGHT)")},
