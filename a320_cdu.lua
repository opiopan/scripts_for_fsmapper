local bitmap1 = graphics.bitmap("assets/a320_cdu.png")
local bitmap2 = graphics.bitmap(128, 128)
local context = graphics.rendering_context(bitmap2)
...
--------------------------------------------------------------------------------------
-- Register viewport definition and view definiton for CDU
--------------------------------------------------------------------------------------
local viewport = mapper.viewport{
    name = "A320 Viewport",
    displayno = 1,
    -- x = 0, y = 0,
    -- width = 0.3 * (4/3) / (16/9), height = 0.6,
    x = 0.5, y = 0,
    width = 0.5, height = 1,
    -- displayno = 2,
    -- x = 0.5, y = 0,
    -- width = 0.5, height = 1,
    bgcolor = graphics.color(0, 0, 64),
}
